...
public class LoanAssistant extends JFrame
{
    ...
    public static void main(String args[]) {new LoanAssistant().setVisible(true);}
            ...
            if (validateDecimalNumber(paymentTextField))
            {
                ...
                if (payment <= (balance * monthlyInterest + 1.0))
                {
                    if (JOptionPane.showConfirmDialog(null, "Minimum payment must be $" +new DecimalFormat("0.00").format((int)(balance * monthlyInterest + 1.0)) + "\n" + "Do you" +
                                    "want to use the minimum payment?", "Input Error", JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
                    {
